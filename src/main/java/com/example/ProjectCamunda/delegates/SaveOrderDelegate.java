...
public class SaveOrderDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        execution.setVariable("itemId", order.getItemId());
        execution.setVariable("customerDetails", order.getCustomerDetails());
        execution.setVariable("noOfItems", order.getNoOfItems());
